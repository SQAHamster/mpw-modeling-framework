...
/**
 * Simple helper class which is used to debug purposes. It converts complex,
 * custom annotation parts in a model tree to simple annotations to ensure they
 * are loadable as a simple XMI file.
 */
public class CustomAnnotationConverter {
    ...
    private void convertReference(final EObject sourceObject, final EAnnotation targetAnnotation,
    ...
    private EClass convertAttributes(final EObject sourceObject, final EAnnotation targetAnnotation) {
        ...
        eClass.getEAllAttributes().stream().forEach(attribute -> {
    ...
    private void convertForReference(final EObject referencedEObject, final EAnnotation targetAnnotation,
            final EReference reference) {
    ...
    private static void putIfFeatureExists(final EObject eObject, final String featureName,
