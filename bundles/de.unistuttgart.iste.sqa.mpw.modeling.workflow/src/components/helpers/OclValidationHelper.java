...
/**
 * Helper class which validates a resource content with a given OCL validation file.
 */
public class OclValidationHelper {
	...
	// Note: ocl instance has to be kept in this variable, since it must not be garbage collected until the last validation through this object ends
