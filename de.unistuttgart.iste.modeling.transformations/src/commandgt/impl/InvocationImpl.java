 ...
 * </p>
 * <ul>
 *   <li>{@link commandgt.impl.InvocationImpl#getTargetMethodName <em>Target Method Name</em>}</li>
 *   <li>{@link commandgt.impl.InvocationImpl#getMappedParameters <em>Mapped Parameters</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InvocationImpl extends MinimalEObjectImpl.Container implements Invocation {
	...
	protected EClass eStaticClass() {
		return CommandgtPackage.Literals.INVOCATION;
	}
	...
	public void setTargetMethodName(String newTargetMethodName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommandgtPackage.INVOCATION__TARGET_METHOD_NAME, oldTargetMethodName, targetMethodName));
	}
	...
	public EList<Parameter> getMappedParameters() {
		if (mappedParameters == null) {
			mappedParameters = new EObjectResolvingEList<Parameter>(Parameter.class, this, CommandgtPackage.INVOCATION__MAPPED_PARAMETERS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CommandgtPackage.INVOCATION__TARGET_METHOD_NAME:
				return getTargetMethodName();
			case CommandgtPackage.INVOCATION__MAPPED_PARAMETERS:
