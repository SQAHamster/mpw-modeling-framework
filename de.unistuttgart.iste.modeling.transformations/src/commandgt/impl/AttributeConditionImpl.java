 ...
 * </p>
 * <ul>
 *   <li>{@link commandgt.impl.AttributeConditionImpl#getInstance <em>Instance</em>}</li>
 *   <li>{@link commandgt.impl.AttributeConditionImpl#getAttributeName <em>Attribute Name</em>}</li>
 *   <li>{@link commandgt.impl.AttributeConditionImpl#getAttributeValueLiteral <em>Attribute Value Literal</em>}</li>
 *   <li>{@link commandgt.impl.AttributeConditionImpl#isIsCreate <em>Is Create</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AttributeConditionImpl extends MinimalEObjectImpl.Container implements AttributeCondition {
	...
	protected EClass eStaticClass() {
		return CommandgtPackage.Literals.ATTRIBUTE_CONDITION;
	}
		...
		if (instance != null && instance.eIsProxy()) {
			...
			if (instance != oldInstance) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CommandgtPackage.ATTRIBUTE_CONDITION__INSTANCE, oldInstance, instance));
			}
		}
		return instance;
	}
	...
	public void setInstance(InstanceCondition newInstance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommandgtPackage.ATTRIBUTE_CONDITION__INSTANCE, oldInstance, instance));
	}
	...
	public void setAttributeName(String newAttributeName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommandgtPackage.ATTRIBUTE_CONDITION__ATTRIBUTE_NAME, oldAttributeName, attributeName));
	}
	...
	public void setAttributeValueLiteral(String newAttributeValueLiteral) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommandgtPackage.ATTRIBUTE_CONDITION__ATTRIBUTE_VALUE_LITERAL, oldAttributeValueLiteral, attributeValueLiteral));
	}
	...
	public void setIsCreate(boolean newIsCreate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommandgtPackage.ATTRIBUTE_CONDITION__IS_CREATE, oldIsCreate, isCreate));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CommandgtPackage.ATTRIBUTE_CONDITION__INSTANCE:
				if (resolve) return getInstance();
				return basicGetInstance();
			case CommandgtPackage.ATTRIBUTE_CONDITION__ATTRIBUTE_NAME:
				return getAttributeName();
			case CommandgtPackage.ATTRIBUTE_CONDITION__ATTRIBUTE_VALUE_LITERAL:
				return getAttributeValueLiteral();
			case CommandgtPackage.ATTRIBUTE_CONDITION__IS_CREATE:
				return isIsCreate();
		}
