 ...
 * </p>
 * <ul>
 *   <li>{@link commandgt.impl.SingleReferenceConditionImpl#isIsForbid <em>Is Forbid</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SingleReferenceConditionImpl extends ReferenceConditionImpl implements SingleReferenceCondition {
	...
	protected EClass eStaticClass() {
		return CommandgtPackage.Literals.SINGLE_REFERENCE_CONDITION;
	}
	...
	public void setIsForbid(boolean newIsForbid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommandgtPackage.SINGLE_REFERENCE_CONDITION__IS_FORBID, oldIsForbid, isForbid));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CommandgtPackage.SINGLE_REFERENCE_CONDITION__IS_FORBID:
				return isIsForbid();
		}
