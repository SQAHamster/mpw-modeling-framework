 ...
 * @generated
 */
public class CommandgtSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CommandgtPackage.TRANSFORMATION: {
				Transformation transformation = (Transformation)theEObject;
				T result = caseTransformation(transformation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CommandgtPackage.UNIT: {
				Unit unit = (Unit)theEObject;
				T result = caseUnit(unit);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CommandgtPackage.RULE: {
			...
			case CommandgtPackage.ATTRIBUTE_CONDITION: {
				AttributeCondition attributeCondition = (AttributeCondition)theEObject;
				T result = caseAttributeCondition(attributeCondition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CommandgtPackage.INSTANCE_CONDITION: {
				InstanceCondition instanceCondition = (InstanceCondition)theEObject;
				T result = caseInstanceCondition(instanceCondition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CommandgtPackage.REFERENCE_CONDITION: {
				ReferenceCondition referenceCondition = (ReferenceCondition)theEObject;
				T result = caseReferenceCondition(referenceCondition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CommandgtPackage.SINGLE_REFERENCE_CONDITION: {
				SingleReferenceCondition singleReferenceCondition = (SingleReferenceCondition)theEObject;
				T result = caseSingleReferenceCondition(singleReferenceCondition);
				if (result == null) result = caseReferenceCondition(singleReferenceCondition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CommandgtPackage.MANY_REFERENCE_CONDITION: {
				ManyReferenceCondition manyReferenceCondition = (ManyReferenceCondition)theEObject;
				T result = caseManyReferenceCondition(manyReferenceCondition);
				if (result == null) result = caseReferenceCondition(manyReferenceCondition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CommandgtPackage.MODIFICATION: {
				Modification modification = (Modification)theEObject;
				T result = caseModification(modification);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CommandgtPackage.VARIABLE_ASSIGNMENT: {
				VariableAssignment variableAssignment = (VariableAssignment)theEObject;
				T result = caseVariableAssignment(variableAssignment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CommandgtPackage.VARIABLE_DECLARATION: {
				VariableDeclaration variableDeclaration = (VariableDeclaration)theEObject;
				T result = caseVariableDeclaration(variableDeclaration);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CommandgtPackage.SEQUENTIAL_UNIT: {
			...
			case CommandgtPackage.ITERATED_UNIT: {
			...
			case CommandgtPackage.INVOCATION: {
				Invocation invocation = (Invocation)theEObject;
				T result = caseInvocation(invocation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CommandgtPackage.PARAMETER: {
				Parameter parameter = (Parameter)theEObject;
				T result = caseParameter(parameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CommandgtPackage.CONDITIONAL_UNIT: {
			...
			case CommandgtPackage.CONDITION: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Instance Condition</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Instance Condition</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseInstanceCondition(InstanceCondition object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Reference Condition</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Reference Condition</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseReferenceCondition(ReferenceCondition object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Single Reference Condition</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Single Reference Condition</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSingleReferenceCondition(SingleReferenceCondition object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Many Reference Condition</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Many Reference Condition</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseManyReferenceCondition(ManyReferenceCondition object) {
		return null;
	}
