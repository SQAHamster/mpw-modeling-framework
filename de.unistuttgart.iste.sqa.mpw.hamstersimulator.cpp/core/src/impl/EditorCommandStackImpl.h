#ifndef DE_UNISTUTTGART_HAMSTER_EDITORCOMMANDSTACKIMPL_H
#define DE_UNISTUTTGART_HAMSTER_EDITORCOMMANDSTACKIMPL_H
...
#endif //DE_UNISTUTTGART_HAMSTER_EDITORCOMMANDSTACKIMPL_H
