#ifndef DE_UNISTUTTGART_HAMSTER_GAMEPERFORMANCEIMPL_H
#define DE_UNISTUTTGART_HAMSTER_GAMEPERFORMANCEIMPL_H
...
#endif //DE_UNISTUTTGART_HAMSTER_GAMEPERFORMANCEIMPL_H
