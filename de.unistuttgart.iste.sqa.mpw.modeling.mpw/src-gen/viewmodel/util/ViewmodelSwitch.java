...
public class ViewmodelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ViewmodelPackage.PRESENTER: {
				Presenter presenter = (Presenter)theEObject;
				T result = casePresenter(presenter);
				if (result == null) result = caseViewStereotype(presenter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ViewmodelPackage.VIEW_MODEL: {
				ViewModel viewModel = (ViewModel)theEObject;
				T result = caseViewModel(viewModel);
				if (result == null) result = caseViewStereotype(viewModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ViewmodelPackage.VIEW_STEREOTYPE: {
				ViewStereotype viewStereotype = (ViewStereotype)theEObject;
				T result = caseViewStereotype(viewStereotype);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
