 ...
 * </p>
 * <ul>
 *   <li>{@link commandBehavior.impl.IteratedUnitImpl#getRepeat <em>Repeat</em>}</li>
 *   <li>{@link commandBehavior.impl.IteratedUnitImpl#getTargetInvocation <em>Target Invocation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IteratedUnitImpl extends UnitImpl implements IteratedUnit {
	...
	protected EClass eStaticClass() {
		return CommandPackage.Literals.ITERATED_UNIT;
	}
	...
	public void setRepeat(String newRepeat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommandPackage.ITERATED_UNIT__REPEAT, oldRepeat, repeat));
	}
	...
	public NotificationChain basicSetTargetInvocation(Invocation newTargetInvocation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CommandPackage.ITERATED_UNIT__TARGET_INVOCATION, oldTargetInvocation, newTargetInvocation);
	...
	public void setTargetInvocation(Invocation newTargetInvocation) {
		if (newTargetInvocation != targetInvocation) {
			...
			if (targetInvocation != null)
				msgs = ((InternalEObject)targetInvocation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CommandPackage.ITERATED_UNIT__TARGET_INVOCATION, null, msgs);
			if (newTargetInvocation != null)
				msgs = ((InternalEObject)newTargetInvocation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CommandPackage.ITERATED_UNIT__TARGET_INVOCATION, null, msgs);
			msgs = basicSetTargetInvocation(newTargetInvocation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommandPackage.ITERATED_UNIT__TARGET_INVOCATION, newTargetInvocation, newTargetInvocation));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CommandPackage.ITERATED_UNIT__TARGET_INVOCATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CommandPackage.ITERATED_UNIT__REPEAT:
				return getRepeat();
			case CommandPackage.ITERATED_UNIT__TARGET_INVOCATION:
