 ...
 * </p>
 * <ul>
 *   <li>{@link commandBehavior.impl.SequentialUnitImpl#getTargetInvocations <em>Target Invocations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SequentialUnitImpl extends UnitImpl implements SequentialUnit {
	...
	protected EClass eStaticClass() {
		return CommandPackage.Literals.SEQUENTIAL_UNIT;
	}
	...
	public EList<Invocation> getTargetInvocations() {
		if (targetInvocations == null) {
			targetInvocations = new EObjectContainmentEList<Invocation>(Invocation.class, this, CommandPackage.SEQUENTIAL_UNIT__TARGET_INVOCATIONS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CommandPackage.SEQUENTIAL_UNIT__TARGET_INVOCATIONS:
