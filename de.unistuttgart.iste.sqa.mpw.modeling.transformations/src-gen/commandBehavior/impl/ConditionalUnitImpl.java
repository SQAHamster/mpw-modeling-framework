 ...
 * </p>
 * <ul>
 *   <li>{@link commandBehavior.impl.ConditionalUnitImpl#getConditions <em>Conditions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConditionalUnitImpl extends UnitImpl implements ConditionalUnit {
	...
	protected EClass eStaticClass() {
		return CommandPackage.Literals.CONDITIONAL_UNIT;
	}
	...
	public EList<Condition> getConditions() {
		if (conditions == null) {
			conditions = new EObjectContainmentEList<Condition>(Condition.class, this, CommandPackage.CONDITIONAL_UNIT__CONDITIONS);
		}
		return conditions;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CommandPackage.CONDITIONAL_UNIT__CONDITIONS:
