 ...
 * </p>
 * <ul>
 *   <li>{@link queryBehavior.impl.CompareExpressionImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CompareExpressionImpl extends BinaryExpressionImpl implements CompareExpression {
	...
	protected EClass eStaticClass() {
		return QueryPackage.Literals.COMPARE_EXPRESSION;
	}
	...
	public void setOperator(CompareOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QueryPackage.COMPARE_EXPRESSION__OPERATOR, oldOperator, operator));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QueryPackage.COMPARE_EXPRESSION__OPERATOR:
				return getOperator();
		}
