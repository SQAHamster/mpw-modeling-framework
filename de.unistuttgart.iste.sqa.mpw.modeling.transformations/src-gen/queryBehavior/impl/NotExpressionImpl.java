 ...
 * </p>
 * <ul>
 *   <li>{@link queryBehavior.impl.NotExpressionImpl#getInner <em>Inner</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NotExpressionImpl extends ExpressionImpl implements NotExpression {
	...
	protected EClass eStaticClass() {
		return QueryPackage.Literals.NOT_EXPRESSION;
	}
	...
	public NotificationChain basicSetInner(Expression newInner, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, QueryPackage.NOT_EXPRESSION__INNER, oldInner, newInner);
	...
	public void setInner(Expression newInner) {
		if (newInner != inner) {
			...
			if (inner != null)
				msgs = ((InternalEObject)inner).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - QueryPackage.NOT_EXPRESSION__INNER, null, msgs);
			if (newInner != null)
				msgs = ((InternalEObject)newInner).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - QueryPackage.NOT_EXPRESSION__INNER, null, msgs);
			msgs = basicSetInner(newInner, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QueryPackage.NOT_EXPRESSION__INNER, newInner, newInner));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case QueryPackage.NOT_EXPRESSION__INNER:
